 ...
 * @版本: V1.0
 * 
 * @日期: 2013-1-12 下午10:28:49
 * 
 * @描述: 类<code>NetworkManager</code>是管理GPRS和WIFI等开关的类</p>
 * 
	...
	public boolean isGprsEnable() {
		...
		try {
			...
			Method method = ConnectivityManager.class.getMethod(
					"getMobileDataEnabled", argClass);
			isEnable = (Boolean) method.invoke(connManager, argObject);
		} catch (Exception e) {
